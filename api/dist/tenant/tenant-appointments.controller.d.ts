...
export declare class TenantAppointmentsController {
    ...
    list(req: AuthenticatedRequest): import("../infrastructure/sql-db/sql-db.types").AppointmentEntity[];
    create(req: AuthenticatedRequest, dto: CreateAppointmentDto): import("../infrastructure/sql-db/sql-db.types").AppointmentEntity;
    ...
    patchAttendance(req: AuthenticatedRequest, appointmentId: string, dto: PatchAppointmentAttendanceDto): import("../infrastructure/sql-db/sql-db.types").AppointmentEntity;
}
export {};
