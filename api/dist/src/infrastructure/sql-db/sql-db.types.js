...
exports.DEFAULT_PLATFORM_SITE_CONFIG = void 0;
exports.DEFAULT_PLATFORM_SITE_CONFIG = {
    currencyCode: 'COP',
    currencySymbol: '$',
    ...
    landing: {
        ...
        heroLead: 'Azenda combina agenda inteligente, POS ligero y stock para negocios que viven de las reservas. Activa solo los módulos que necesitas.',
        ...
        demoSub: 'Tus clientes eligen servicio, fecha y hora en una página limpia. Horario por franjas y recordatorios vía WhatsApp manual (wa.me).',
...
//# sourceMappingURL=sql-db.types.js.map